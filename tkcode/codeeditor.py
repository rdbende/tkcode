...
class CodeEditor(codebox.BaseCodeBox):
    def __init__(self, master=tk._default_root, language="python",
                 highlighter="mariana", autofocus=False, **kwargs):
    ...
    def change_cursor_mode(self, event: tk.Event = None):
        ...
        self.config(blockcursor=False if self["blockcursor"] else True)
